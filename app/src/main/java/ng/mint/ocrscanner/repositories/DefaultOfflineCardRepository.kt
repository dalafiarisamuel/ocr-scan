...
class DefaultOfflineCardRepository @Inject constructor(private val dao: OfflineCardDao) :
    ...
    override suspend fun insertSingle(data: OfflineCard) = dao.insertSingle(data)

    override suspend fun delete(data: OfflineCard) = dao.delete(data)
